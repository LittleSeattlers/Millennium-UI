...
export function buildFinalizationPrompt({ reason = 'The reserved finalization window has begun.', secondsRemaining = 240 } = {}) {
  const seconds = boundedInteger(secondsRemaining, 15, 600, 240);
