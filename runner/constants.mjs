...
export const RUNNER_VERSION = '0.6.10';
...
export const FINALIZATION_RESERVE_MINUTES = 4;
export const QUOTA_RESERVE_PERCENT = 5;
export const WEEKLY_QUOTA_RESERVE_PERCENT = 1;
export const QUOTA_RISK_MODE = 'harvest';
...
export const RISK_MODES = Object.freeze({
  ...
  harvest: {
    label: 'Harvest',
    reservePercent: QUOTA_RESERVE_PERCENT,
    maxMinutes: 120,
    checkpointMinutes: 10,
    calibrationMinutes: 5,
    burnMultiplier: 1.15,
