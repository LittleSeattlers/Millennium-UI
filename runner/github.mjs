...
export async function publishContribution(handle, record) {
  ...
  const body = [
    ...
    `<!-- millennium-contribution:v1 ${record.attempt_id} -->`,
    'This pull request contains one canonical, strict-schema research contribution with best-effort credential screening.',
    '',
