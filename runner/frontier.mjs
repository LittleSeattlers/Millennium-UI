...
function adaptiveSliceFor(parent) {
  ...
  return {
    ...
    rationale: `The parent task's ${parent.suggestedMinutes}-minute editorial budget does not fit the current allowance. This fixed preparatory slice creates a reusable foothold instead of truncating or pretending to complete the parent.`,
...
function recommendationScore(task, safeMinutes) {
  ...
  return task.priority + fit + verificationBonus + dependencyUnlockBonus + accumulatedContextBonus;
}
